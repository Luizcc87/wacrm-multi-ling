-- message_templates uniqueness is account-scoped after 017_account_sharing.
-- The legacy user-scoped index blocks/permits the wrong combinations once
-- teammates share the same WhatsApp Business account.
