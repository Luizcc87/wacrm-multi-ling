      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-muted-foreground mt-1">
            {t('pageDescription')} {totalCount > 0 && t('totalContacts', { count: totalCount })}
          </p>
        </div>
        <div className="flex items-center gap-2">
          {canEditSettings && (
            ...
            >
              ...
              {t('customFieldsButton') || "Custom fields"}
            </Button>
          )}
          <GatedButton
            variant="outline"
                  ...
                  {allTags.map((tag) => (
                    ...
                    >
                      <Checkbox
                        ...
                        aria-label={t('filterByTagAria', { name: tag.name }) || `Filter by ${tag.name}`}
                      />
                      <span
              ...
              return (
                ...
                >
                  ...
                  <button
                    ...
                    aria-label={t('removeTagFilterAria', { name: tag.name }) || `Remove ${tag.name} filter`}
            ...
            <TableRow className="border-border hover:bg-transparent">
              <TableHead className="w-10">
                <Checkbox
                  ...
                  aria-label={t('selectAllOnPage') || "Select all contacts on this page"}
                />
              </TableHead>
              ...
              <TableHead className="text-muted-foreground hidden md:table-cell">{t('tagsLabel')}</TableHead>
                ...
                >
                  <TableCell onClick={(e) => e.stopPropagation()}>
                    <Checkbox
                      ...
                      aria-label={t('selectContactAria', { name: contact.name || contact.phone }) || `Select ${contact.name || contact.phone}`}
                    />
                  </TableCell>
          ...
          <DialogHeader>
            ...
            <DialogDescription className="text-muted-foreground">
              {t('deleteContactDescription', {
                name: deleteTarget?.name || deleteTarget?.phone || t('unnamed', 'Unnamed'),
              })}
            </DialogDescription>
          </DialogHeader>
